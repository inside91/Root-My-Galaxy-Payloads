...
#define BUILD_FINGERPRINT \
  "samsung/a54xnsxx/a54x:16/BP4A.251205.006/A546EXXSLFZG3:user/release-keys"
#endif
...
#define FOPS_KERNEL_PAGE_SETUP_ATTEMPTS 12
#define FOPS_FRESH_PAGE_ATTEMPTS 5
#define FOPS_ROUTE_COARSE_DELAY_USEC 45000
